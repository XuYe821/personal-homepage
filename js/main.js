// function showqqcode() {
//     document.getElementById("qqcode").innerHTML = "<img src='static\\img\\qqcode.png' alt='qqcode' width='100%' height='auto'>"
//     document.getElementById("qq").outerHTML = '<p id="qq" onclick="hideqqcode()">↓&nbsp&nbspQQ：<b>30738009</b>(单击收码)</p>'
// }
// function hideqqcode() {
//     document.getElementById("qqcode").innerHTML = ""
//     document.getElementById("qq").outerHTML = '<p id="qq" onclick="showqqcode()">→QQ：<b>30738009</b>(单击出码)</p>'
// }
// function showwechatcode() {
//     document.getElementById("wechatcode").innerHTML = "<img src='static\\img\\wechatcode.png' alt='wechatcode' width='100%' height='auto'>"
//     document.getElementById("wechat").outerHTML = '<p id="wechat" onclick="hidewechatcode()">↓&nbsp&nbsp微信：<b>y30738009</b>(单击收码)</p>'
// }
// function hidewechatcode() {
//     document.getElementById("wechatcode").innerHTML = ""
//     document.getElementById("wechat").outerHTML = '<p id="wechat" onclick="showwechatcode()">→微信：<b>y30738009</b>(单击出码)</p>'
// }
